...
import "@globals"; // Import global CSS
...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center pt-1 pb-36 px-4 bg-background text-white">
            ...
            <div className="bg-black p-4 rounded-lg shadow-lg w-full max-w-sm">
                ...
                <button
                    onClick={handleLogin}
                    className="w-full mt-4 bg-secondary text-white py-2 rounded hover:bg-secondary transition-all"
                >
                    Login
                </button>
            </div>
